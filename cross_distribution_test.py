...
def main():
    ...
    # Load ALL test datasets (including all-hard)
    ...
    datasets = {
        ...
        "all-hard": load_pickle(project_root / "test-all-hard-dataset.pkl"),
    }
    ...
    # Length-hard (own test = length-hard)
    ...
    # All-hard (own test = all-hard)
    print(f"{'All-hard':<15} {'(20-50, 3-10)':<15} {results['all-hard']['all-hard']*100:>10.1f} {results['all-hard']['length-hard']*100:>12.1f} {results['all-hard']['mult-hard']*100:>10.1f}")
